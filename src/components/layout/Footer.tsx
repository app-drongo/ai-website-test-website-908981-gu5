...
const DEFAULT_FOOTER = {
  ...
  contactEmail: 'support@testwebsite.com',
  contactPhone: '+1 (555) 847-2901',
  contactAddress: '2847 Innovation Drive, Tech Hub 200, San Francisco, CA',
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Webhooks', href: '/webhooks', editableId: 'link-footer-webhooks' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Leadership', href: '/leadership', editableId: 'link-footer-leadership' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Feature Requests', href: '/feedback', editableId: 'link-footer-feedback' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Cookie Preferences', href: '/cookies', editableId: 'link-footer-cookies' },
      ],
    },
  ];
  ...
  const bottomLinks = [
    ...
    { name: 'Contact Support', href: '/support', editableId: 'link-footer-support' },
  ];
