...
const DEFAULT_PRICING = {
  badge: 'Pricing Plans',
  mainTitle: 'Choose Your Perfect',
  mainTitleHighlight: 'Website Package',
  mainDescription:
    'Get your professional website up and running with our flexible pricing options. All plans include hosting, SSL, and 24/7 support.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 25%',
  plan1Name: 'Basic',
  plan1Description: 'Perfect for personal websites and portfolios',
  plan1Price: '$9',
  plan1CTA: 'Start Basic Plan',
  plan1CTAHref: '/',
  plan2Name: 'Professional',
  plan2Description: 'Ideal for businesses and e-commerce sites',
  plan2Price: '$29',
  plan2Period: '/month',
  plan2Badge: 'Most Popular',
  plan2CTA: 'Start Pro Plan',
  plan2CTAHref: '/',
  plan2Trial: '7-day free trial • No setup fees',
  plan3Name: 'Enterprise',
  plan3Description: 'Custom solutions for large organizations',
  plan3Price: '$99',
  plan3Badge: 'Best Value',
  plan3CTA: 'Get Enterprise',
  plan3CTAHref: '/',
  bottomTitle: 'Need a custom solution?',
  bottomDescription:
    'Our team can create a tailored website package that perfectly fits your unique requirements and business goals.',
  bottomCTA: 'Request Custom Quote',
  bottomCTAHref: '/',
} as const;
