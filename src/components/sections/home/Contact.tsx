...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    "Have questions about our services? Want to see a demo? We're here to help you find the perfect solution for your needs.",
  ...
  office1Address: '123 Demo Street, Suite 456',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Los Angeles',
  office2Address: '789 Test Avenue, Floor 12',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Chicago',
  office3Address: '456 Preview Boulevard, Building C',
